...
const TriangleExclamationSolidIcon = SVGIcon
TriangleExclamationSolidIcon.displayName = 'TriangleExclamationSolid'
export default TriangleExclamationSolidIcon
